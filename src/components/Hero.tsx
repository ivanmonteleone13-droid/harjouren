      ...
      {heroImage && (
        <>
          <img
            ...
            fetchPriority="high"
          />
          <div className="absolute inset-0 bg-[var(--dark)]/70" aria-hidden />
        </>
      )}
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="rounded-3xl bg-white/80 p-10 shadow-xl backdrop-blur-sm sm:p-16">
          <div className="flex flex-col items-start gap-8 lg:flex-row lg:items-center">
            ...
            <div className="w-full max-w-xs rounded-2xl bg-gradient-to-br from-[var(--primary)] to-[var(--secondary)] p-8 text-center text-white lg:w-auto">
              ...
              <p className="text-sm opacity-80">av 5 stjärnor · {business.reviewCount}+ omdömen</p>
              <a
